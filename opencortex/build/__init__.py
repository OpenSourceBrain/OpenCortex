...
def add_probabilistic_projection(net, 
                                 ...
                                 weight=1):     
    """
    Add a projection between `presynaptic_population` and `postsynaptic_population` with probability of connection between each pre & post pair of cells given by `connection_probability`
    """
...
def add_elect_projection0(nml_doc,
                          net,
                          prefix,
                          presynaptic_population,
                          postsynaptic_population,
