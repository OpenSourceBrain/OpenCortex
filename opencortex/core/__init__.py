...
def save_network(nml_doc, nml_file_name, validate=True, format='xml', max_memory=None, target_dir='./', use_subfolder=True):
    ...
    oc_build._finalise_copy_to_dir_for_model(nml_doc, target_dir, use_subfolder =use_subfolder)
