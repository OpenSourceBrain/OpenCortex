...
popHH = oc.add_single_cell_population(
    network, "popHH", "pyr_4_sym_soma", z=100, color="0 .8 0"
)
"""
...
pgIzh = oc.add_pulse_generator(
    nml_doc, id="pgIzh", delay="100ms", duration="300ms", amplitude="0.5nA"
)

pgHH = oc.add_pulse_generator(
    nml_doc, id="pgHH", delay="100ms", duration="300ms", amplitude="0.7nA"
)
"""                                     
...
oc.generate_lems_simulation(
    nml_doc, network, nml_file_name, duration, dt, report_file_name="report.iclamp.txt"
)
